...
Return COMPLETE after you have satisfied the users request
Your tools are:
...
Your duty is to select a tool from your list of tools and return the tool that best accomplishes your next step in satisfying the users request
You should take very few steps to COMPLETE each task, with the exception being for very difficult tasks
DO NOT directly answer the users request
REPLY ONLY with a tool call
NEVER REPEAT YOUR TOOL CALL
Return COMPLETE if you see in your history that you have returned a response recently
"""+f"{TOOLS}"+"""
